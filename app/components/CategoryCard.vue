<template>
  <div class="m-4 my-8 mb-12 bg-gray-100 rounded-lg">
    <section class="container">
  
      <div class="flex justify-between items-center mb-6">
        <a class=" font-bebas-neue text-primary tracking-widetext-xl sm:text-2xl">
          etalase kategori
        </a>
...
const baseCategories: Category[] = [
  { name: 'Fashion & Aksesoris', icon: '👕', bgColor: 'bg-white' },
  { name: 'Makanan', icon: '🍜', bgColor: 'bg-white' },
  { name: 'Minuman', icon: '🍹', bgColor: 'bg-white' },
  { name: 'Jasa', icon: '🤝', bgColor: 'bg-white' },
  { name: 'Pertanian & Perkebunan', icon: '🌾', bgColor: 'bg-white' },
  { name: 'ATK', icon: '📚', bgColor: 'bg-white' },
  { name: 'Kosmetik', icon: '💄', bgColor: 'bg-white' },
];
