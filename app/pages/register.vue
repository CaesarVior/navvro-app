<template>
    <div class="flex flex-col lg:flex-row min-h-screen bg-white lg:h-screen lg:overflow-hidden">
        ...
        <div
            class="w-full lg:w-6/11 bg-[url('/icon/log.png')] max-w-[850px] max-h-[600px] bg-cover bg-no-repeat text-white flex flex-col justify-end sm:p-12 lg:px-10 order-first lg:order-last">
